...
public class RecyclerView1Adapter extends RecyclerView.Adapter<RecyclerView1Adapter.MyViewHolder> {
    ...
    private List<MessageBean.DataBean.CommentsListBean> mDatas;
    ...
    public RecyclerView1Adapter(Context context, List<MessageBean.DataBean.CommentsListBean> mDatas) {
    ...
    //创建ViewHolder
    @Override
    public RecyclerView1Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    //绑定viewHolder
    @Override
    public void onBindViewHolder(final RecyclerView1Adapter.MyViewHolder holder, final int position) {
        MessageBean.DataBean.CommentsListBean msg=mDatas.get(position);
